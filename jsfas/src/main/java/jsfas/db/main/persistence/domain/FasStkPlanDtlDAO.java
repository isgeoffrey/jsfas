...
@Entity
@Table(name = "FAS_STK_PLAN_DTL")
public class FasStkPlanDtlDAO implements Serializable, Comparable<FasStkPlanDtlDAO> {

    private static final long serialVersionUID = 7014784243669996645L;

    @EmbeddedId
    private FasStkPlanDtlDAOPK fasStkPlanDtlDAOPK;
	...
	public FasStkPlanDtlDAOPK getFasStkPlanDtlDAOPK() {
		return fasStkPlanDtlDAOPK;
	}

	public void setFasStkPlanDtlDAOPK(FasStkPlanDtlDAOPK fasStkPlanDtlDAOPK) {
		this.fasStkPlanDtlDAOPK = fasStkPlanDtlDAOPK;
	}
	
	@Override
	public int compareTo(FasStkPlanDtlDAO o) {
		return (Integer.valueOf(this.fasStkPlanDtlDAOPK.hashCode()).compareTo(Integer.valueOf(o.getFasStkPlanDtlDAOPK().hashCode())));
	}
