...
@Entity
@Table(name="EL_APPL_COLIST_COURSE_HIST")
public class ElApplColistCourseHistDAO implements Serializable {
	...
	public ElApplColistCourseHistDAO(ElApplColistCourseDAO originDAO, ElApplCourseHistDAO crseDAO) {
		super();
		this.id = UUID.randomUUID().toString();
		this.applHdrId = originDAO.getApplHdrId();
		this.colistCrseTerm = originDAO.getColistCrseTerm();
		this.colistCrseId = originDAO.getColistCrseId();
		this.colistCrseOfferNbr = originDAO.getColistCrseOfferNbr();
		this.colistCrseCde = originDAO.getColistCrseCde();
		...
		this.applCrseId = crseDAO.getId();
		this.versionNo = crseDAO.getVersionNo();
	...
	public ElApplColistCourseHistDAO() {
		super();
		this.id = UUID.randomUUID().toString();
		this.applHdrId = " ";
		this.applCrseId = " ";
