...
@Entity
@Table(name="EL_APPL_PYMT_METHOD_HIST")
public class ElApplPymtMethodHistDAO implements Serializable {
	...
	public ElApplPymtMethodHistDAO() {
		super();
	...
	public ElApplPymtMethodHistDAO(ElApplPymtMethodDAO elApplPymtMethodDAO, ElApplHdrDAO hdrDAO) {
		super();
		this.id = UUID.randomUUID().toString();
		this.applHdrId = elApplPymtMethodDAO.getApplHdrId();
		this.applElTypeId = elApplPymtMethodDAO.getApplElTypeId();
		this.versionNo = hdrDAO.getVersionNo();
		this.pymtCategory = elApplPymtMethodDAO.getPymtCategory();
		this.pymtLineNo = elApplPymtMethodDAO.getPymtLineNo();
		this.pymtTypeCde = elApplPymtMethodDAO.getPymtTypeCde();
		this.pymtFreq = elApplPymtMethodDAO.getPymtFreq();
		this.pymtAmt = elApplPymtMethodDAO.getPymtAmt();
		this.pymtStartDt = elApplPymtMethodDAO.getPymtStartDt();
		this.pymtEndDt = elApplPymtMethodDAO.getPymtEndDt();
